...
namespace DAL_PolyCafe
{
    ...
    {
        public List<ThongKeTheoLoaiSanPham> GetDoanhThuTheoLoaiSP(string maLoaiSP, DateTime tuNgay, DateTime denNgay)
        {
            ...
            thamSo.Add(tuNgay);
            thamSo.Add(denNgay);
            List<ThongKeTheoLoaiSanPham> result = new List<ThongKeTheoLoaiSanPham>();
            SqlDataReader reader = DBUNTIL.Query(sql, thamSo, CommandType.StoredProcedure);
            if (reader.HasRows)
            {
                while (reader.Read())
                {
                    ThongKeTheoLoaiSanPham tk = new ThongKeTheoLoaiSanPham();
        ...
        public List<ThongKeTheoNhanVien> GetDoanhThuTheoNhanVien(string maNV, DateTime tuNgay, DateTime denNgay)
        {
            ...
            if (reader.HasRows)
            {
                while (reader.Read())
                {
                    ThongKeTheoNhanVien tk = new ThongKeTheoNhanVien();
